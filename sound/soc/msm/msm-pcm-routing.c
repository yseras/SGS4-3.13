...
static const struct snd_kcontrol_new ss_solution_mixer_controls[] = {
	SOC_SINGLE_EXT("SA data", SND_SOC_NOPM, 0, 65535, 0,
				msm_sec_sa_get, msm_sec_sa_put),
	SOC_SINGLE_EXT("VSP data", SND_SOC_NOPM, 0, 65535, 0,
				msm_sec_vsp_get, msm_sec_vsp_put),
	SOC_SINGLE_EXT("Audio DHA data", SND_SOC_NOPM, 0, 65535, 0,
				msm_sec_dha_get, msm_sec_dha_put),
	SOC_SINGLE_EXT("LRSM data", SND_SOC_NOPM, 0, 65535, 0,
				msm_sec_lrsm_get, msm_sec_lrsm_put),
	SOC_SINGLE_EXT("SA_EP data", SND_SOC_NOPM, 0, 65535, 0,
